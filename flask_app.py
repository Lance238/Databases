...
class OrderItemsDB:
    ...
    def delete_OrderItems(self, OrderItemsID):
        ...
        self.cur.execute("DELETE Orders, OrderItems FROM Orders INNER JOIN OrderItems ON Orders.OrderID = OrderItems.OrderID WHERE OrderItems.OrderItemID = %s", (OrderItemsID, ))
        self.con.commit()
        self.con.close()
